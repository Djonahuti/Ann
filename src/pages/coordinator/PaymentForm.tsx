...
const paymentSchema = z.object({
  ...
  completed_by: z.enum(["Cleophas", "Emmanuel", "Roland", "Mukaila", "Deborah", "David", "Adaobi"], { required_error: "Make a selection" }),
  coordinator: z.enum(["Cleophas", "Emmanuel", "Roland", "Mukaila"], { required_error: "Coordinator is required" }),
  bus: z.number().int().positive(),
  p_week: z.enum(["First", "Second", "Third", "No Payment Made"], { required_error: "Make a Selection" }),
  receipt: z.any().refine((file) => file?.length > 0, "Receipt is required"),
  amount: z.coerce.number().int().nonnegative(),
  sender: z.string().nullable(),
  payment_day: z.enum(["MON", "TUE", "WED", "THU", "FRIDAY", "SAT", "SUN", "SAT(Early)"], { required_error: "Day of the Week is required" }),
  ...
  pay_complete: z.enum(["YES", "NO"], { required_error: "Make a Selection" }),
  issue: z.enum(["N/A - No Issues Collecting Money", "Could Not Reach Driver", "Bus Down", "Driver Late Making Payment", "Bus to be Repossessed", "No Payment Made"], { required_error: "Make a Selection" }),
  inspection: z.enum(["YES", "NO"], { required_error: "Make a Selection" }),
});
