  ...
  return (
    <div className="max-w-6xl mx-auto p-8 space-y-6">
      ...
      <div className="flex space-x-4 pt-6">
        <Button variant="outline" onClick={() => navigate('/admin/pages')}>Cancel</Button>
