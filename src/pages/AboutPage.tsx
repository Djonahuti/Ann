            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Founded in 2009, Annhurst Global Service Limited has been at the forefront 
                  of transportation financing in Nigeria. We started with a simple mission: 
                  to make bus ownership accessible to transportation entrepreneurs.
                </p>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Over the years, we've helped hundreds of businesses expand their fleets, 
                  create jobs, and contribute to the growth of Nigeria's transportation sector. 
                  Our commitment to excellence and customer satisfaction has made us the 
                  trusted partner for bus financing solutions.
                </p>
              </div>
              <div className="relative">
                <div className="aspect-[4/3] rounded-2xl bg-gray-900/5 object-cover">
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-600/20 to-blue-800/20"></div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Bus className="w-32 h-32 text-blue-600" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-blue-600">Our Purpose</h2>
